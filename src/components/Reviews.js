...
function Reviews() {
  return (
    ...
    <Heading fontSize='50' textAlign={['center', 'center', 'center', 'center']} mt='50px' lineHeight='63px'><span style={{ 'fontWeight': '500' }} >From our</span>  <span style={{ 'color': '#3071E7', 'fontWeight': '700' }} >Padhai</span> <span style={{ 'fontWeight': '500' }} >community</span></Heading>
    <Text w='100%' mt='20px'
                        fontSize='20px'
                        lineHeight='30px'
                        textAlign='center'
